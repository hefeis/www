...
<div class="side-nav-panel-right">
    <ul id="slide-out-right" class="side-nav side-nav-panel collapsible">
        ...
        <li><a href="{{url('mstore/login')}}"><i class="fa fa-sign-in"></i>Login</a></li>
        <li><a href="{{url('mstore/reg')}}"><i class="fa fa-user-plus"></i>Register</a></li>
    </ul>
</div>
<!-- end side nav right-->
    ...
    <div class="modal-content">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col s4">
                    <a href="{{url('mstore/login')}}" class="button-link">
                        <div class="menu-link">
                            <div class="icon">
                ...
                <div class="col s4">
                    <a href="{{url('mstore/reg')}}" class="button-link">
                        <div class="menu-link">
                            <div class="icon">
